...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "OcrApiGateway3@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "OcrApiGateway3 API";

        private String description = "OcrApiGateway3 API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "OcrApiGateway3";
